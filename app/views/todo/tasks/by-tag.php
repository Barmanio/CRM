...
<h1 class="mb-4">Список задач по тегу: <span>"<?=$tagname;?>"</span></h1>
...
<div class="accordion" id="tasks-accordion">
    <?php foreach ($tasksByTag as $one_task): ?>
    <?php
    ...
    <div class="accordion-item mb-2">
        <div class="accordion-header d-flex justify-content-between align-items-center row" id="task-<?php echo $one_task['task_id']; ?>">
        ...
        <div id="task-collapse-<?php echo $one_task['id']; ?>" class="accordion-collapse collapse row" aria-labelledby="task-<?php echo $one_task['task_id']; ?>" data-bs-parent="#tasks-accordion">
            <div class="accordion-body">
                ...
                <p>
                    ...
                    <?php foreach ($one_task['tags'] as $tag): ?>
                ...
                <div class="d-flex justify-content-end">
                    ...
                    <form action=">/todo/tasks/update-status/<?php echo $one_task['task_id']; ?>" method="POST" class="me-2">
                    ...
                    <a href="/todo/tasks/edit/<?php echo $one_task['task_id']; ?>" class="btn btn-primary me-2">Изменить</a>
                    <a href="/todo/tasks/delete/<?php echo $one_task['task_id']; ?>" class="btn btn-danger me-2">Удалить</a>
                </div>
            </div>
        </div>
    </div>
