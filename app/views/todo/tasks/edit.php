...
<form action="/todo/tasks/update" method="POST">
    ...
    <div class="row">
        ...
        <!-- Reminder date field -->
        <div class="col-12 col-md-6 mb-3">
            <label for="reminder_at">Напоминание за</label>
    ...
    <div class="row">
        ...
        <!-- Finish date field -->
        <div class="col-12 col-md-6 mb-3">
            <label for="finish_date">Срок выполнения</label>
    ...
    <div class="row">
        ...
        <div class="col-12 col-md-6 mb-3">
            ...
            <select class="form-control" id="status" name="status" required>
                ...
                <option value="on_hold" <?= $task['status'] == 'on_hold' ? 'selected' : '' ?>>Ожидает</option>
        ...
        <div class="col-12 col-md-6 mb-3">
            ...
            <select class="form-control" id="priority" name="priority" required>
                ...
                <option value="urgent" <?= $task['priority'] == 'urgent' ? 'selected' : '' ?>>Неотложная</option>
            </select>
        </div>
    </div>
